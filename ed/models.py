...
class feeStructure(models.Model):
    ...
    Hostelfee = models.IntegerField(default=0,verbose_name="Hostel Fee")
    Uniformfee = models.IntegerField(default=0,verbose_name="Uniform Fee")
    Transportaionfee = models.IntegerField(default=0,verbose_name="Transportation Fee")
    Clinicalfee = models.IntegerField(default=0,verbose_name="Clinical Fee")
    Otherfee = models.IntegerField(default=0,verbose_name="Other Fee")
    OtherfeeName = models.CharField(max_length=250,default="Other")
