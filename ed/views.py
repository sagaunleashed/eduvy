...
from ed.models import College,Institution,Branch, Students,SupportingDoc,Course, feeStructure,introBanner,instituteBanner,planBanner,Staff,instituteBranch,institutionCourse
...
def branch(request):
    ...
    if request.method == "POST":
        ...
        Status = request.POST["status"]
        BranchSave = Branch(BranchCode=BranchCode, BranchName=Branchname, Image=Image, Status=Status)
        BranchSave.save()
...
def delete_insitute_course(request):
    if request.method == "POST":
        ...
        instance.delete()
        messages.danger(request, "Institute course deleted successfully!")
        # return redirect(branch)
        data = {
        'is_taken': "deleted"
        }
...
def delete_institutebranch(request):
    if request.method == "POST":
        ...
        instance.delete()
        messages.danger(request, "Institute branch deleted successfully!")
        # return redirect(branch)
        data = {
        'is_taken': "deleted"
        }
...
def delete_institutebanner(request):
    if request.method == "POST":
        ...
        if len(instance.Image) > 0:
            os.remove(instance.Image.path)
        instance.delete()
        messages.danger(request, "Institute Banner deleted successfully!")
        # return redirect(branch)
        data = {
        'is_taken': "deleted"
        }
...
def delete_introbanner(request):
    if request.method == "POST":
        ...
        if len(instance.Image) > 0:
            os.remove(instance.Image.path)
        instance.delete()
        messages.danger(request, "Intro Banner deleted successfully!")
        # return redirect(branch)
        data = {
        'is_taken': "deleted"
        }
...
def delete_institute(request):
    if request.method == "POST":
        ...
        userDelete.delete()
        messages.danger(request, "Institute deleted successfully!")
...
def delete_course(request):
    if request.method == "POST":
        ...
        instance.delete()
        messages.danger(request, "Course deleted successfully!")
        return redirect(branch)
        # data = true
        # return JsonResponse(data)
    return redirect(branch)
...
def list_institute(request):
    if request.method == "POST":
        ...
        print(group)
        context = [ID,Name,State,City,Address,Chairman,Chairperson,email,phone,image,Status,institutionCode,group]
        data = json.dumps(context)
        return HttpResponse(data)
...
def delete_supporting_doc(request):
    if request.method == "POST":
        ...
        instance.delete()
        messages.danger(request, "supporting document deleted successfully!")
        # return redirect(branch)
        data = {
        'is_taken': "deleted"
        }
...
def delete_planbanner(request):
    if request.method == "POST":
        ...
        if len(instance.Image) > 0:
            os.remove(instance.Image.path)
        instance.delete()
        messages.danger(request, "Plan banner deleted successfully!")
        # return redirect(branch)
        data = {
        'is_taken': "deleted"
        }
...
def delete_staff(request):
    if request.method == "POST":
        ...
        messages.danger(request, "Staff deleted successfully!")
        return JsonResponse(data)
    return redirect(planbanner)
    ...
    if request.user.is_superuser:
        ...
        if userid > 1:
            for data in instibranch:
                courses = Course.objects.filter(Branch = data['branchId_id'])
                for i in courses:                
                    courseid  = i.id
...
def delete_student(request):
    if request.method == "POST":
        ...
        instance.delete()
        messages.danger(request, 'Student deleted successfully!')
        # return redirect(branch)
        data = {
        'is_taken': "deleted"
        }
...
def institutecourse_fee(request):
    if request.method == "POST":
        if request.user.is_superuser:
            ...
            try:
                if request.POST['addmission_fee']:
                    x = request.POST['addmission_fee']
                    fee.Admissionfee = x
                    print(x)
            except:
                pass
            try:
                if request.POST['tution_fee']:
                    x = request.POST['tution_fee']
                    fee.Tutionfee = x
                    print(x)
            except:
                pass
            try:
                if request.POST['exam_fee']:
                    x = request.POST['exam_fee']
                    fee.Examfee = x
                    print(x)
            except:
                pass
            try:
                if request.POST['mark_card_fee']:
                    x = request.POST['mark_card_fee']
                    fee.MarksCardfee = x
                    print(x)
            except:
                pass
            try:
                if request.POST['caution_deposit']:
                    x = request.POST['caution_deposit']
                    fee.CautionDeposit = x
                    print(x)
            except:
                pass
            try:
                if request.POST['library_fee']:
                    x = request.POST['library_fee']
                    fee.Libraryfee = x
                    print(x)
            except:
                pass
            try:
                if request.POST['sports_fee']:
                    x = request.POST['sports_fee']
                    fee.Sportsfee = x
                    print(x)
            except:
                pass
            try:
                if request.POST['registration_fee']:
                    x = request.POST['registration_fee']
                    fee.Registrationfee = x
                    print(x)
            except:
                pass
            try:
                if request.POST['hostel_fee']:
                    x = request.POST['hostel_fee']
                    fee.Hostelfee = x
                    print(x)
            except:
                pass
            try:
                if request.POST['uniform_fee']:
                    x = request.POST['uniform_fee']
                    fee.Uniformfee = x
                    print(x)
            except:
                pass
            try:
                if request.POST['transportation_fee']:
                    x = request.POST['transportation_fee']
                    fee.Transportaionfee = x
                    print(x)
            except:
                pass
            try:
                if request.POST['clinical_fee']:
                    x = request.POST['clinical_fee']
                    fee.Clinicalfee = x
                    print(x)
            except:
                pass
            try:
                if request.POST['other_fee']:
                    x = request.POST['other_fee']
                    fee.Otherfee = x
                    print(x)
            except:
                pass
